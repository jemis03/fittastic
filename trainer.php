  ...
  <div class="content">
    <div class="content1">
      <div class="card" style="width: 18rem;">
        <img src="img/gym2.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Trainee Information</h5>
          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
            content.</p>
          <a href="Trainee_manager.php" class="btn btn-primary">Go somewhere</a>
        </div>
      </div>
      ...
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
            content.</p>
          <a href="Watcher.php" class="btn btn-primary">visit </a>
        </div>
      </div>
